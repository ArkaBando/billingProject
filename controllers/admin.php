...
//                }
    ...
    case 'forgot-pw-post':
        ...
        if ($d) {
            ...
            $message->set('password_reset_link', U.'admin/pwreset-validate/'.$d['id'].'/token_'.$xkey);
    ...
    case 'pwreset-validate':
        ...
        if($d){
            ...
            if($v_token != $d_token){
                r2(U.'admin/','e',$_L['Invalid Password Reset Key'].'!');
            }
            $keyexpire = $d['keyexpire'];
            $ctime = time();
            if ($ctime > $keyexpire) {
                r2(U.'admin/','e',$_L['Password Reset Key Expired']);
            }
            $password = _raid('6');
